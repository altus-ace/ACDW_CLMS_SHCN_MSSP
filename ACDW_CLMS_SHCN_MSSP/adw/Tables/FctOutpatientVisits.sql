CREATE TABLE [adw].[FctOutpatientVisits] (
    [FctOutpatientVisitskey] INT           IDENTITY (1, 1) NOT NULL,
    ...
    [SVCProviderParFlag]     CHAR (1)      NULL,
    ...
    PRIMARY KEY CLUSTERED ([FctOutpatientVisitskey] ASC)
);
