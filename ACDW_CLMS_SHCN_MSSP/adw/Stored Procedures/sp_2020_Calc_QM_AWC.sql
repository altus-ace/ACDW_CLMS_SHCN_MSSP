...
BEGIN TRAN
	...
	FROM [adw].[2020_tvf_Get_ClaimsByValueSet]('Well-Care','','','',CONCAT('1/1/',@MeasurementYear), CONCAT('12/31/',@MeasurementYear), CONCAT('12/31/', @MeasurementYear)) 
...
/***
Usage: 
EXEC [adw].[sp_2020_Calc_QM_AWC] '[adw].[QM_ResultByMember_HISTORY]',2019,16
***/
