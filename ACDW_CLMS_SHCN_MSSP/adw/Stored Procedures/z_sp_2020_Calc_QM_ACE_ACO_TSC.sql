...
-- =============================================
CREATE PROCEDURE [adw].[z_sp_2020_Calc_QM_ACE_ACO_TSC] 
...
BEGIN TRAN
	...
	JOIN			(
						...
						FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_TSC_NicotineDependence','',
										'','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffDate) )b
...
/***
Usage: 
EXEC [adw].[sp_2020_Calc_QM_ACE_ACO_TSC] '[adw].[QM_ResultByMember_History]','2020-08-15','2020-01-01',2020,16
***/
