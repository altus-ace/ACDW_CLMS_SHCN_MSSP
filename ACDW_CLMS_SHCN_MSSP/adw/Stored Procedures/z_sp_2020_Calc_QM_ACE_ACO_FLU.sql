...
-- =============================================
CREATE PROCEDURE [adw].[z_sp_2020_Calc_QM_ACE_ACO_FLU] 
...
BEGIN TRAN
	...
	--DECLARE @qmdate date ='2020-05-10'		
			--Declare Variables
	...
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_Influenza Immunization_6 months & older','ACO_Influenza Immunization','','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffDate) 
	UNION
	SELECT			SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate,SEQ_CLAIM_ID, SVC_TO_DATE
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_Influenza Immunization_6 months 35 months','ACO_Influenza Immunization','','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffDate)
	UNION
	SELECT			SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate,SEQ_CLAIM_ID, SVC_TO_DATE
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_Influenza Immunization_2 through 49 years','ACO_Influenza Immunization','','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffDate)
	UNION
	SELECT			SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate,SEQ_CLAIM_ID, SVC_TO_DATE
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_Influenza Immunization_3 years & older','ACO_Influenza Immunization','','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffDate)
	UNION
	SELECT			SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate,SEQ_CLAIM_ID, SVC_TO_DATE
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_Influenza Immunization_4 years & older','ACO_Influenza Immunization','','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffDate)
	UNION
	SELECT			SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate,SEQ_CLAIM_ID, SVC_TO_DATE
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_Influenza Immunization_18 years & older','ACO_Influenza Immunization','','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffDate)
	UNION
	SELECT			SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate,SEQ_CLAIM_ID, SVC_TO_DATE
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_Influenza Immunization_65  years & olde','ACO_Influenza Immunization','','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffDate)
...
/***
Usage: 
EXEC [adw].[sp_2020_Calc_QM_ACE_ACO_FLU]'[adw].[QM_ResultByMember_History]','2020-07-15','2020-01-01',2020,16
***/

	--@ConnectionStringProd,@QMDATE DATE,@CodeEffectiveDate,@MeasurementYear,@ClientKeyID	
