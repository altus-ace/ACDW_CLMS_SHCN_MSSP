...
(
		SELECT B1.[SEQ_CLAIM_ID]
		  ...
		  INNER JOIN
			(
				SELECT DISTINCT C3.SEQ_CLAIM_ID, L33.VC AS VALUE_CODE, L33.VALUE_CODE_SYSTEM, L33.VALUE_SET_OID
				FROM adw.Claims_Diags C3
				INNER JOIN
				(
					SELECT DISTINCT VALUE_CODE_WithoutDot as VC, VALUE_CODE_SYSTEM, VALUE_SET_OID
