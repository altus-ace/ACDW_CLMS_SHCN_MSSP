...
CREATE PROCEDURE [ast].[FailedLogMbrMember]
...
--  delete from [AceMetaData].amd.[AceBusinessRuleLog] where BusRuleLogKey <> 1

--  DBCC CHECKIDENT ('[AceMetaData].amd.[AceBusinessRuleLog]', RESEED, 1)  
