CREATE TABLE [ast].[FctMembership] (
    ...
    [LoadDate]                    DATE            NULL,
    [stgRowStatus]                VARCHAR (20)    CONSTRAINT [DF_astFctMbr_StgRowStatusMS] DEFAULT ('Not Valid') NOT NULL,
    ...
    CONSTRAINT [CK_FctMbr_stgRowStatusMS] CHECK ([stgRowStatus]='Exported' OR [stgRowStatus]='Valid' OR [stgRowStatus]='Loaded' OR [stgRowStatus]='Not Valid')
);
