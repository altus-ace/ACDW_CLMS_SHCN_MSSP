CREATE TABLE [adi].[Steward_MSSPPartBClaimBenefitEnhancement] (
    [MSSPPartBClaimBenefitEnhancementKey]                     INT           IDENTITY (1, 1) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([MSSPPartBClaimBenefitEnhancementKey] ASC)
);
